<div id="receipt_wrapper">
	...
	<table id="receipt_items">
		...
		foreach(array_reverse($cart, true) as $line=>$item)
		{
			?>
			<tr>
				<td><span class='long_name'> <?php echo $item['is_serialized'] ? $item['description'] : $item['name']; ?></span></td>
				...
				<td><?php
					...
					?></td>
				<td><div class="total-value"><?php echo to_currency($item[($this->Appconfig->get('receipt_show_total_discount') ? 'total' : 'discounted_total')]); ?></div></td>
			</tr>
			<!--
	    <tr>
