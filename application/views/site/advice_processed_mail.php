...
<div>
    ...
    <?=$this->lang->line('gait_video')?>: <strong><?=(isset($_SESSION[GAIT_VIDEO_PATH]) ? site_url($_SESSION(GAIT_VIDEO_PATH)) : $this->lang->line('existing_customer'))?></strong><br>
    <?=$this->lang->line('analysis_comments')?>: <?= $this->input->post( ANALYSIS_COMMENTS) ? $this->input->post( ANALYSIS_COMMENTS ) : "<geen>" ?><br>
</div>
